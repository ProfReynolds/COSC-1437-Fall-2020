        ...
        private void AddTo(BinaryTreeNode<T> node, T value)
        {
            ...
            if (value.CompareTo(node.Value) < 0)
            {
                ...
                if (node.Left == null)
                {
                    ...
                    Debug.WriteLine($"Node left was added to the {node.Value} node; new node is for the value {value}");
                }
                else
                {
            ...
            else
            {
                ...
                if (node.Right == null)
                {
                    ...
                    Debug.WriteLine($"Node right was added to the {node.Value} node; new node is for the value {value}");
                }
                else
                {
